...
<template>
  <section class="md:pt-6">
    <div class="container flex flex-col items-center py-8 mx-auto sm:flex-row">
      ...
      >
        &copy; {{ new Date().getFullYear() }} Products of LCTECH
      </a>
      <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
        ...
        <a v-if="blog" :href="blog" target="_blank" title="Blog" class="text-gray-400 hover:text-gray-500">
        ...
        <a v-if="mastodon" :href="mastodon" target="_blank" title="Mastodon" class="text-gray-400 hover:text-gray-500">
